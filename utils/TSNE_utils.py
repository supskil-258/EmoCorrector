    ...
    if plot:
        ...
        if markers is not None and genes is not None:
            ...
            for num, g in enumerate(markers):
                ...
                plt.scatter(meanExpr[i], zeroRate[i], s=20, color="k")
...
def plot(
    ...
    **kwargs
    ...
    plot_params = {"alpha": kwargs.get("alpha", 1), "s": kwargs.get("s", 30)}
    ...
    if draw_centers:
        ...
        ax.scatter(
            centers[:, 0], centers[:, 1], c=center_colors, s=5, alpha=1, edgecolor="k"
        )
    ...
    # Hide ticks and axis
    ticks=[-20,-15,-10,-5,0,5,10,15,20,25,30]
    ax.set_xticks(ticks), ax.set_yticks(ticks), ax.axis("on")
