...
from utils.pitch_utils import f0_to_coarse, clean_denorm_f0, clean_norm_f0, noisy_denorm_f0, noisy_norm_f0
...
class FastSpeech2(nn.Module):
    ...
    def add_pitch(self, decoder_inp, f0, uv, mel2ph, ret, encoder_out=None):
        if hparams['pitch_type'] == 'ph':
            ...
            if f0 is None:
                f0 = pitch_pred[:, :, 0]
            ret['f0_denorm'] = f0_denorm = clean_denorm_f0(f0, None, hparams, pitch_padding=pitch_padding)
        ...
        if hparams['pitch_type'] == 'cwt':
            ...
            if hparams['use_uv'] and uv is None:
                uv = pitch_pred[:, :, 1] > 0
        ret['f0_denorm'] = f0_denorm = clean_denorm_f0(f0, uv, hparams, pitch_padding=pitch_padding)
    ...
    def cwt2f0_norm(self, cwt_spec, mean, std, mel2ph):
        ...
        f0_norm = clean_norm_f0(f0, None, hparams)
        return f0_norm
